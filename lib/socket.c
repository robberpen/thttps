...
******************************************************/
SOCKET InetInitSockaddr(const char *host,
			unsigned short port,
			int type, struct sockaddr_in *skaddr)
{
...
*		v1.0 stable
***********************************************************/
SOCKET InetSockCliInit(const char *host, unsigned short port, int type,
		       struct sockaddr_in * cliaddr)
{
	...
	if ((res =
	     connect(s, (struct sockaddr *) cliaddr,
...
SOCKET InetSockSrvInit(const char *host, unsigned short port, int type,
